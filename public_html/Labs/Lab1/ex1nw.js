...
// ********************************************************
// ********************************************************
function buildSphere(np, np2){// np and np2 decides the spaceNumber for each dot
	var vPos = new Array;
	...
	for(theta = 0.0; theta < 2*Math.PI; theta+=angle){
		for(alfa = 0.0; alfa < Math.PI; alfa+=angle2){
			var theta2 = randomFromInterval(10,0.1) * theta;
			var alfa2 = randomFromInterval(5,0.1) * alfa;
